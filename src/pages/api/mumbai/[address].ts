...
export default async function handler(
 ...
 const { uri, metadata } = await metaplex
   ...
   .uploadMetadata({
     ...
     image: "https://arweave.net/rwDpeiQyDMXPaQt_QgSICn5ayZls653qcedmjkDhYlo",
     description:
       "The Gateway of India is an arch-monument built in the early 20th century in the city of Bombay new Mumbai.",
     attributes: [
       {
         trait_type: "time",
